...
const Header = () => {
  ...
  return (
    ...
    transition={{delay:0.2, duration:0.8}}
      ...
      <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'>Turn text to <span className='text-purple-700'
      ...
      className='mt-2 text-neutral-600'>Generated images from GetImage</motion.p>
    </motion.div>
  )
}
