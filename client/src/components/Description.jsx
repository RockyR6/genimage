    ...
    className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center '>
        ...
        <div>
            ...
            <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI image generator. Whenther you need stunnig visuals or unique imagery, our tool transforms your text into eye-catching images whith just a few clicks. Imagine it, describe it, and watch it come to life instantly. </p>
